    ...
    <div className="charte_container">
      <div className="charte_container_main">
        <div className="charte_container_title">
          <h1 className="charte_title">Conditions Générales d'Utilisation</h1>
        </div>
        <div className="charte_main">
          <section>
            <p className="charte_main_conditions">
              <h2 className="align">Conditions générales d'utilisation</h2>
              <p className="align">En vigueur au 28/08/2022</p>
              <p>
                Les présentes conditions générales d'utilisation (dites « CGU »)
                ont pour objet l'encadrement juridique des modalités de mise à
                disposition du site et des services par Develott et de définir
                les conditions d’accès et d’utilisation des services par «
                l'Utilisateur ». Les présentes CGU sont accessibles sur le site
                à la rubrique «CGU». Toute inscription ou utilisation du site
                implique l'acceptation sans aucune réserve ni restriction des
                présentes CGU par l’utilisateur. Lors de l'inscription sur le
                site via le Formulaire d’inscription, chaque utilisateur accepte
                ...
                les accepte ». En cas de non-acceptation des CGU stipulées dans
                le présent contrat, l'Utilisateur se doit de renoncer à l'accès
                des services proposés par le site. Develott.fr se réserve le
                droit de modifier unilatéralement et à tout moment le contenu
                des présentes CGU.
              </p>
              <h3>ARTICLE 1 : Les mentions légales</h3> L'édition du site
              Develott.fr est assurée par la Société Sarl Develott au capital de
              100000 euros, immatriculée au RCS de _______________ sous le
              numéro _______________, dont le siège social est situé au
              _______________ Numéro de téléphone _______________ Adresse e-mail
              : _______________. Le Directeur de la publication est :
              _______________ L'hébergeur du site Develott.fr est la société
              Heroku, dont le siège social est situé au _______________, avec le
              numéro de téléphone : _______________.
              <h3>ARTICLE 2 : Accès au site</h3>
              Le site Develott.fr permet à l'Utilisateur un accès gratuit aux
              services suivants : Le site internet propose les services suivants
              : Services pour les devs Junior Le site est accessible
              gratuitement en tout lieu à tout Utilisateur ayant un accès à
              Internet. Tous les frais supportés par l'Utilisateur pour accéder
              au service (matériel informatique, logiciels, connexion Internet,
              etc.) sont à sa charge. L’Utilisateur non membre n'a pas accès aux
              services réservés. Pour cela, il doit s’inscrire en remplissant le
              formulaire. En acceptant de s’inscrire aux services réservés,
              l’Utilisateur membre 1 s’engage à fournir des informations
              sincères et exactes concernant son état civil et ses coordonnées,
              notamment son adresse email. Pour accéder aux services,
              l’Utilisateur doit ensuite s'identifier à l'aide de son
              identifiant et de son mot de passe qui lui seront communiqués
              après son inscription. Tout Utilisateur membre régulièrement
              inscrit pourra également solliciter sa désinscription en se
              rendant à la page dédiée sur son espace personnel. Celle-ci sera
              effective dans un délai raisonnable. Tout événement dû à un cas de
              force majeure ayant pour conséquence un dysfonctionnement du site
              ou serveur et sous réserve de toute interruption ou modification
              en cas de maintenance, n'engage pas la responsabilité de
              Develott.fr. Dans ces cas, l’Utilisateur accepte ainsi ne pas
              tenir rigueur à l’éditeur de toute interruption ou suspension de
              service, même sans préavis. L'Utilisateur a la possibilité de
              ...
              <h3>ARTICLE 4 : Propriété intellectuelle</h3> Les marques, logos,
              signes ainsi que tous les contenus du site (textes, images, son…)
              ...
              Les sources des informations diffusées sur le site Develott.fr
              ...
              Develott.fr ne peut être tenu responsable de la modification des
              ...
              dans ce site. L'Utilisateur s'assure de garder son mot de passe
              secret. Toute divulgation du mot de passe, quelle que soit sa
              forme, est interdite. Il assume les risques liés à l'utilisation
              de son identifiant et mot de passe. Le site décline toute
              responsabilité. 2 Le site Develott.fr ne peut être tenu pour
              ...
              du site Develott.fr. Ce dernier n’a pas de contrôle sur les pages
              ...
              site Develott.fr. Les cookies ne contiennent pas d’information
              ...
              Develott.fr. En naviguant sur le site, L’Utilisateur les accepte.
              ...
              _______________. Dans ses publications, le membre s’engage à
              respecter les règles de la Netiquette (règles de bonne conduite de
              l’internet) et les règles de droit en vigueur. Le site peut
              exercer une modération sur les publications et se réserve le droit
              de refuser leur mise en ligne, sans avoir à s’en justifier auprès
              du membre. Le membre reste titulaire de l’intégralité de ses
              droits de propriété intellectuelle. Mais en publiant une
              publication sur le site, il cède à la société éditrice le droit
              non exclusif et gratuit de représenter, reproduire, adapter,
              modifier, diffuser et distribuer sa publication, directement ou
              par un tiers autorisé, dans le monde entier, sur tout support
              ...
              3 La société éditrice s'engage à faire figurer le nom du membre à
              proximité de chaque utilisation de sa publication. Tout contenu
              mis en ligne par l'Utilisateur est de sa seule responsabilité.
              L'Utilisateur s'engage à ne pas mettre en ligne de contenus
              pouvant porter atteinte aux intérêts de tierces personnes. Tout
              recours en justice engagé par un tiers lésé contre le site sera
