            ...
            <div className=" desc_container_description-links-informations">
              <div className="desc_container_description-links">
                <p className="desc_container_title user-available">
                  <i class="fas fa-circle success"></i> Disponible pour débuter
                  un nouveau projet
                </p>
                <p className="desc_container_title">
                  <i class="fas fa-map-marker color-secondary"></i> Montpellier
                </p>
                <p className="desc_container_title">
                ...
                <p className="desc_container_title">
                  <i class="fab fa-github color-secondary"></i>{" "}
                  <a href="#"> Superman-Suck</a>{" "}
                </p>
                <p className="desc_container_title">
                  <i class="fab fa-linkedin color-secondary"></i>{" "}
                  <a href="#"> Bruce Wayne</a>
                </p>
                <p className="desc_container_title">
                  <i class="fas fa-globe color-secondary"></i>{" "}
