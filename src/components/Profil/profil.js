				...
				<div className="desc_container_description">
					...
					<div className="desc_container_description-user">
						...
						<p className="desc_container_title">
							<i className="fas fa-circle success"></i> Disponible pour débuter
							un nouveau projet
						</p>
					</div>
					<div className="desc_container_description-links">
						<p className="desc_container_title">
							<i className="fal fa-map-marked"></i> Montpellier
						</p>
						<p className="desc_container_title">
							<i className="fal fa-envelope"></i> batman@batmail.batfr
						</p>
						<p className="desc_container_title">
							<i className="fab fa-github"></i> <a href="#"> Superman-Suck</a>{" "}
						</p>
						<p className="desc_container_title">
							<i className="fab fa-linkedin"></i> <a href="#"> Bruce Wayne</a>
						</p>
						<p className="desc_container_title">
							<i className="far fa-laptop"></i> <a href="#"> brucewayne.com</a>
						</p>
					</div>
					<p className="desc_container_title">
