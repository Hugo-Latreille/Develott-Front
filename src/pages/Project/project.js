        ...
        <div className="project-container-right">
          <div className="project-description">
            ...
            <p className="project-description-desc">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut vel ex
              quis lorem tempus consequat. Pellentesque ornare eros eget ante
              elementum blandit. Aenean sed neque venenatis, ultrices risus vel,
              dignissim.Ut vel ex quis lorem tempus consequat. Pellentesque
              ornare eros. dolor sit amet, consectetur adipiscing elit.
            </p>
