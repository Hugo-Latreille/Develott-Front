...
function TeamCreationCharteForm({ userId, refetch }) {
	...
	return (
		<>
			<div className="charte-container-main">
				<section>
					<p className="charte_main_section">
						...
						engagez à respecter des règles de bonne conduite. Nous nous gardons
						le droit de supprimer tout Projet qui ne respecterait pas les règles
						de la présente charte d’utilisation. Vous vous engagez notamment à
						respecter les lois et règlements en vigueur ainsi que le droit des
						personnes. Sont notamment illicites (liste non exhaustive) :
					</p>
					<ul>
						...
						<li className="charte_main_list">
							la diffamation (imputation d’un fait portant atteinte à l’honneur
							ou à la considération de la personne physique ou morale, ou du
						...
						<li className="charte_main_list">
							...
							les analyses et courtes citations sont possibles, sous réserve que
							soient indiqués clairement le nom de l’auteur et la source. Plus
							généralement le contributeur s’engage à respecter les droits de
							propriété intellectuelle des auteurs
						</li>{" "}
						<li className="charte_main_list">
							les contributions ayant la nature de publicités. Plus
							généralement, tout utilisateur s’engage à respecter des règles de
							bonnes conduite et à : ne pas écrire entièrement en langage abrégé
							ou en majuscules
						</li>{" "}
						<li className="charte_main_list">
						...
						<li className="charte_main_list">
							...
							messages dans le but d’entraver ou de fausser le fonctionnement de
							cet espace (phénomènes pollupostage)
						</li>{" "}
					</ul>
				</section>
			</div>
			<div className="btn_charte_modal">
				<button
					onClick={() => {
						updateUser({ id: userId, charte: true });
						refetch();
					}}
					className="main-button-bg-colored border"
				>
...
export default TeamCreationCharteForm;
